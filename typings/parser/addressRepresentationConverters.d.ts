...
export declare const rowAddressFromImmutableReference: (immutableReferenceMapping: ImmutableReferenceMapping, stringAddress: string, baseAddress: SimpleCellAddress) => Maybe<RowAddress>;
/**
