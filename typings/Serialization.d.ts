...
export declare class Serialization {
    ...
    getCellFormulaImmutable(address: SimpleCellAddress, targetAddress?: SimpleCellAddress): Maybe<string>;
    getCellSerializedImmutable(address: SimpleCellAddress, targetAddress?: SimpleCellAddress): RawCellContent;
