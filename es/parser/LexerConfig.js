...
import { ALL_WHITESPACE_PATTERN, COLUMN_REFERENCE_PATTERN, NON_RESERVED_CHARACTER_PATTERN, ODFF_WHITESPACE_PATTERN, RANGE_OPERATOR, ROW_REFERENCE_PATTERN, UNICODE_LETTER_PATTERN, IMMUTABLE_CELL_REFERENCE_PATTERN, IMMUTABLE_COL_REFERENCE_PATTERN, IMMUTABLE_ROW_REFERENCE_PATTERN } from './parser-consts';
...
export const ImmutableColRange = createToken({
  name: 'ImmutableColRange',
  pattern: new RegExp(`${IMMUTABLE_COL_REFERENCE_PATTERN}${RANGE_OPERATOR}${IMMUTABLE_COL_REFERENCE_PATTERN}`)
});
export const ImmutableRowRange = createToken({
  name: 'ImmutableRowRange',
  pattern: new RegExp(`${IMMUTABLE_ROW_REFERENCE_PATTERN}${RANGE_OPERATOR}${IMMUTABLE_ROW_REFERENCE_PATTERN}`)
});
...
class ImmutableCellReferenceMatcher {
  constructor() {
    this.cellReferenceRegexp = new RegExp(IMMUTABLE_CELL_REFERENCE_PATTERN, 'y');
  }
  /**
